...
class OASMerger:
    ...
    def get_oas_json(
        ...
        ColorPrint.print_success(f"Fetched {path}")
        return response.json()

    def merge_oas(self) -> None:
        oas = JsonFile.read_json(
            file_path="docs/default-oas"
        )
    ...
    def merge_paths(self) -> dict:
        ...
        ColorPrint.print_info(f"Merged {paths_count} OAS paths: {onchain_paths_count} from /onchain")
        return paths
    ...
    def merge_schemas(self) -> dict:
        ...
        ColorPrint.print_info(f"Merged {schemas_count} OAS schemas: {onchain_schemas_count} from /onchain")
        return schemas
